...
lazy_static! {
    pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
        ...
        OpCode::new(0x29, "ADC", 2, 2, AddressingMode::Immediate),
        OpCode::new(0x25, "ADC", 2, 3, AddressingMode::ZeroPage),
        OpCode::new(0x35, "ADC", 2, 4, AddressingMode::ZeroPage_X),
        OpCode::new(0x2d, "ADC", 3, 4, AddressingMode::Absolute),
        OpCode::new(0x3d, "ADC", 3, 4/*+1 if page crossed*/, AddressingMode::Absolute_X),
        OpCode::new(0x39, "ADC", 3, 4/*+1 if page crossed*/, AddressingMode::Absolute_Y),
    ...
    pub static ref OPCODES_MAP: HashMap<u8, &'static OpCode> = {
        ...
        for cpu_op in &*CPU_OPS_CODES { // could also use CPU_OPS_CODES.iter()
